...
for current_config_set in global_config_sets:
    ...
    if 'lastDeploymentTime' in current_config_set.keys():
    ...
    if 'appSvcsTemplateReference' in current_config_set.keys():
    ...
    if 'applicationReference' in current_config_set.keys():
    ...
    if 'tenantReference' in current_config_set.keys():
    ...
    if 'deviceReference' in current_config_set.keys():
